...
/*   Updated: 2023/12/09 15:09:32 by rlarabi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    if (!strcmp(endptr, "nan")|| strlen(endptr) != 0 || value > INT_MAX || value < INT_MIN)
...
{
    if (strlen(endptr) != 0 || value > INT_MAX || value < INT_MIN)
...
{
    if (strlen(endptr) != 0 || value > FLT_MAX || value < -FLT_MIN)
...
{
    if (strlen(endptr) != 0|| value > DBL_MAX || value < -DBL_MIN)
